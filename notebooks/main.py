...
indexer = FPSIndexer(
    ...
    low_fps=1,
    high_fps_interval=3)
indexer.max_idx, indexer.video_fps, indexer.idx_delta, indexer.high_fps_idx_interval, len(
    indexer.video)
